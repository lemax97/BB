...
public class Entity {
    ...
    public void setBoundingBoxSize(float percentageWidthReduced, float percentageHeigthReduced){
        ...
        //.8f for 20% (1 - .20)
        float heightReductionAmount = 1.0f - percentageHeigthReduced;
        //.8f for 20% (1 - .20)
